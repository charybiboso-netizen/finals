<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('admin.staff.index')" :active="request()->routeIs('admin.staff*')">Staff</x-responsive-nav-link>
            <x-responsive-nav-link :href="route('admin.customers.index')" :active="request()->routeIs('admin.customers*')">Customers</x-responsive-nav-link>
            <x-responsive-nav-link :href="route('admin.bookings.index')" :active="request()->routeIs('admin.bookings*')">Bookings</x-responsive-nav-link>
            ...
            @elseif(auth()->user()->isStaff())
            <x-responsive-nav-link :href="route('staff.dashboard')" :active="request()->routeIs('staff.dashboard')">Dashboard</x-responsive-nav-link>
            ...
            <x-responsive-nav-link :href="route('staff.pickup-schedule')" :active="request()->routeIs('staff.pickup-schedule')">Pickups</x-responsive-nav-link>
            <x-responsive-nav-link :href="route('staff.delivery-schedule')" :active="request()->routeIs('staff.delivery-schedule')">Deliveries</x-responsive-nav-link>
            @elseif(auth()->user()->isCustomer())
            ...
            <x-responsive-nav-link :href="route('customer.services.index')" :active="request()->routeIs('customer.services*')">Services</x-responsive-nav-link>
            <x-responsive-nav-link :href="route('customer.bookings.create')" :active="request()->routeIs('customer.bookings.create')">Book Now</x-responsive-nav-link>
            <x-responsive-nav-link :href="route('customer.bookings.index')" :active="request()->routeIs('customer.bookings.index')">My Bookings</x-responsive-nav-link>
            <x-responsive-nav-link :href="route('customer.notifications.index')" :active="request()->routeIs('customer.notifications*')">Notifications</x-responsive-nav-link>
            @endif
            @endauth
        </div>
